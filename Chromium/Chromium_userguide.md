...
如需在计算机上查找所下载的文件，请依次点击文件名旁边的向下箭头>在文件夹中显示，或依次点击“更多”图标>在 Finder 中显示。

#### 5.3.1 暂停或取消下载

1、在屏幕底部，找到要暂停下载或要取消下载的文件。

2、在屏幕底部相应文件名旁边点击向下箭头>或“更多”图标。
...
### 5.5 在 Chromium 中清除、启用和管理 Cookie
...
无法正常翻译？请尝试刷新该网页。如果仍然无法正常翻译，请右键点击该页面中的任意位置，然后点击翻成相应语言。
