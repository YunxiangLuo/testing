...
单击工具箱中的画笔。在图像中单击您希望线条开始或结束的位置。屏幕上将出现一个点。这个点的大小代表当前画笔大小，您可以在画笔对话框中更改它（参见第 3.2 节，“画笔对话框”）。现在，让我们开始画一条线。按住Shift键，并按住它。
...
这是一个强大的功能。您可以使用任何绘图工具绘制直线。你甚至可以在这条线的末尾画更多的线。我们的最后一步是松开Shift键，我们就完成了。下一节将显示一些示例。GIMP快乐！